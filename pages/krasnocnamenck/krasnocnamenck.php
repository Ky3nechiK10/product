...
<head>
    ...
    <link rel="stylesheet" href="krasnocnamenck.css">
</head>
<body>
    <header class="header" id="header">
        <div class="container">
            ...
            <div class="header_text">
                <h1>Улвекательная тропа Краснознаменск</h1>
            </div>
        </div>
    </header>
    ...
    <div class="container">
        <main class="container_main">
            <div class="container__main-header">
                <h2 class="container__main-description">Краснозноменск</h2>
                <div class="cards">
                    <div class="card">
                        <img class="card__image" src="../../img/image 9.png">
                    ...
                    <div class="card card__even">
                        <img class="card__image" src="../../img/image 9 (1).png">
                        <p class="card__text">"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."</p>
                    </div>
                </div>
    ...
    <!-- <section class="description">
        <div class="container">
            <h2 class="description_name">Краснознаменск</h2>
            ...
            <div class="pop_up" id="pop_up">
                <div class="pop_up_container">
                    <div class="pop_up_body" id="pop_up_body">
                        <p>Запись на экскурсию</p>
                        <form class="js-form">
                            <input class="input js-input" type="text" placeholder="ФИО">
                            <input class="input js-input js-input-email" type="email" placeholder="Почта">
                            <input class="input js-input js-input-phone" type="tel" placeholder="Номер телефона">
                            <select name="subject">
                                <option value="1">Краснознаменск</option>
                                <option value="2">Бальга</option>
                                <option value="3">Корнево</option>
                            </select>
