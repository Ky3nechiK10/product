...
<head>
    ...
    <title>Корнево</title>
    <link rel="stylesheet" href="kornevo.css">
        ...
        <div class="container">
            <div class="container_header">
                ...
                <div class="header_entrace">
                    <a href="../../account/Extern.php" class="entrance"><img src="../../img/Entrance.svg" alt="Вход"></a>
                </div>
                <div class="burger">
                    <span></span>
                </div>
            ...
            <div class="header_text">
                <h1>Увлекательная тропа Корнево</h1>
            </div>
        </div>
    </header>
    ...
    <div class="container">
        <main class="container_main">
            <div class="container__main-header">
                <h2 class="container__main-description">Корнево</h2>
                <div class="cards">
                    <div class="card">
                        <img class="card__image" src="../../img/image 7.png">
                    ...
                    <div class="card card__even">
                        <img class="card__image" src="../../img/image 8.png">
                        <p class="card__text">"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."</p>
                    </div>
                </div>
    ...
    <footer class="footer" id="footer">
        <div class="container">
            <div class="footer_nav">
                <a class="footer_nav-logo" href="#header"><img class="footer_nav-logo_image" src="../../img/logo.svg" alt=""></a>
